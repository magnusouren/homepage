  ...
  <div>
    <div className="ml-auto mr-auto max-w-xl px-4">
      ...
      <p className="my-4 text-justify">
        {`I am a 22 year old student from Trondheim, Norway. I grew up and come
      ...
      <p className="my-4 text-justify">
        ...
        student organization for informatics, called Online. I am also a part of
        the board for the student organization. My role in the board is to
      ...
      <p className="my-4 text-justify">
        ...
        gived me a lot of useful experience. Mainly working with Wordpress, but
        also some other technologies.
      </p>
      <p className="my-4 text-justify">
        I am not a big fan of writing about myself, so I will leave it at that.
        But something that is really cool is that mostly of this content is
        generated with Github Copilot and I am very impressed with the results.
        And yes I have made sure that the content is correct.
      </p>
    </div>
  </div>
);
